...
var EvoRoom = {
    ...
    ancestorsText: {
        ...
        "miacid":"Miacids (Miacidae) were primitive carnivores which lived during the late Paleocene and Eocene epochs about 62—33 million years ago. Miacids existed for approximately 29 million years." /n
        ...
        "pterosaur":"Pterosaurs are extinct flying reptiles. Pterosaurs are not dinosaurs (or birds for that matter), but close relatives of them. They lived worldwide in all kinds of environments and ranged from around 50 cm to 13 m in wingspan. They existed from about 225 to 65 million years ago and thus ran alongside the dinosaurs pretty much toe to toe for their entire existence, dying out in the great extinction at the end of the Cretaceous period. Although they first appeared in the Triassic period, their origins might extend beyond that by some margin, but fossils of this time are rare, so it is hard to say." /n
        ...
        "thecodont":"The Thecodonts were a diverse group of Triassic reptiles that included small, agile two- and four-legged forms, large four-legged carnivores, armored herbivores, and crocodile-like aquatic reptiles. They gave rise to crocodiles, dinosaurs, and probably flying reptiles (pterosaurs)." /n
        		"The Thecodontia are defined by certain shared primitive or ancestral features, such as the suborbital fenestra (an opening on each side of the skull between the eye sockets and the nostrils) and teeth in sockets. The name Thecodont is actually Latin for “socket-tooth,” referring to the fact that thecodont teeth were set in sockets in the jawbones; an archosaurian characteristic that was inherited by the dinosaurs." /n
        		"Thecodontia therefore is an evolutionary grade of animals, rather than a clade. They represent a 'grab-bag' taxon for any archosaur that wasn't a crocodilian, a pterosaur, or a dinosaur. Most palaeontologists nowadays use the term 'basal archosaur' to refer to Thecodonts." /n
        ...
        "yanornis":"Yanornis is an extinct genus of omnivorous Early Cretaceous birds, thought to be closely related to the common ancestor of all modern birds. The genus name Yanornis is derived from the Ancient Chinese Yan dynasties, whose capital was at Chaoyang, and Ancient Greek ornis, 'bird'. The species Y. martini was named for avian paleontologist Larry Martin." /n
...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    formatOrganismString: function(organismString) {
        ...
        // ancestors    
            ...
            return "Heptodon";
        } else if (organismString === "hylobatidae") {
            return "Hylobatidae";
